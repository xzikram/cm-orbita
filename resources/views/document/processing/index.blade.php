...
<div class="space-y-6">
    ...
    <!-- Empty form for bulk sending, linked via HTML5 form attribute to checkboxes below -->
    <form id="bulk-send-form" action="{{ route('communication.deliveries.create') }}" method="GET" class="hidden"></form>
                ...
                @forelse($documents as $doc)
                    <tr>
                        <td class="!pl-3 !pr-1 text-center">
                            <input type="checkbox" name="processed_document_ids[]" value="{{ $doc->id }}" form="bulk-send-form" class="doc-checkbox rounded border-slate-300 text-primary-600 focus:ring-primary-600">
                        </td>
                        <td>
