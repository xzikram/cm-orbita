...
<div class="max-w-3xl mx-auto">
    <div class="sm:flex sm:items-center sm:justify-between mb-6">
        <div class="sm:flex-auto">
            <h1 class="text-base font-semibold leading-6 text-slate-900 dark:text-white">Tambah Pasien Baru</h1>
            <p class="mt-2 text-sm text-slate-700 dark:text-slate-400">Masukkan data rekam medis pasien baru ke dalam sistem.</p>
        </div>
    ...
    <div class="card p-6">
        <form action="{{ route('follow-up.patients.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    ...
                    <div class="mt-2">
                        <input type="text" name="name" id="name" required value="{{ old('name') }}" class="input-field" placeholder="Sesuai KTP">
                    </div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input type="text" name="nik" id="nik" maxlength="16" value="{{ old('nik') }}" class="input-field" placeholder="16 Digit NIK">
                    </div>
                ...
                <div>
                    ...
                    <div class="mt-2 flex gap-2">
                        <input type="text" name="medical_record_number" id="medical_record_number" required value="{{ old('medical_record_number') }}" class="input-field" placeholder="Misal: 00-11-22">
                        <button type="button" onclick="generateTempRM()" class="btn-secondary px-3 whitespace-nowrap text-xs" title="Generate No. RM Sementara untuk Downtime">
                            RM Sementara
                        </button>
                    </div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input type="email" name="email" id="email" value="{{ old('email') }}" class="input-field" placeholder="Untuk pengiriman dokumen">
                    </div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input type="text" name="parent_spouse_name" id="parent_spouse_name" value="{{ old('parent_spouse_name') }}" class="input-field" placeholder="Nama ayah/ibu/suami/istri">
                    </div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input type="text" name="emergency_contact_name" id="emergency_contact_name" value="{{ old('emergency_contact_name') }}" class="input-field" placeholder="Nama kerabat terdekat">
                    </div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input type="text" name="emergency_contact_phone" id="emergency_contact_phone" value="{{ old('emergency_contact_phone') }}" class="input-field" placeholder="No. HP kontak darurat">
                    </div>
                ...
                <div class="sm:col-span-2">
                    <div class="relative flex items-start">
                        <div class="flex h-6 items-center">
                            <input id="is_downtime_entry" name="is_downtime_entry" type="checkbox" value="1" {{ old('is_downtime_entry') == '1' ? 'checked' : '' }} class="h-4 w-4 rounded border-gray-300 text-amber-600 focus:ring-amber-500">
                        </div>
            ...
            function generateTempRM() {
                ...
                document.getElementById('medical_record_number').value = yyyymmdd + '-' + hhmmss;
                
                // Also auto check downtime checkbox when user clicks Temp RM
                document.getElementById('is_downtime_entry').checked = true;
            }
            </script>
