    ...
    <div class="page-header">
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <div class="mt-4 sm:mt-0 sm:flex-none flex items-center gap-3">
                <a href="{{ route('follow-up.events.export-all') }}" class="btn-secondary flex items-center gap-2">
                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12m4.5 4.5V3" />
                    </svg>
                    Ekspor Semua Event
                </a>
                <a href="{{ route('follow-up.events.create') }}" class="btn-primary flex items-center gap-2">
