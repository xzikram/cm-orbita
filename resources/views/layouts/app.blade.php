<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full bg-[#f8fafc]" x-data="{ sidebarOpen: false }">
<head>
    <meta charset="utf-8">
        ...
        <div class="lg:pl-72">
            ...
            <main class="py-10">
                <div class="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
                    ...
                    @if (session('success'))
                        <div class="mb-6 rounded-lg bg-green-50 dark:bg-green-900/30 p-4 ring-1 ring-green-500/20" x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 5000)" x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
                    ...
                    @if (session('error'))
                        <div class="mb-6 rounded-lg bg-red-50 dark:bg-red-900/30 p-4 ring-1 ring-red-500/20" x-data="{ show: true }" x-show="show">
                            <div class="flex items-center">
                                <div class="shrink-0">
