...
@section('title', 'Edit Klinik / Cabang')

@section('content')
<div class="max-w-3xl mx-auto">
    <div class="sm:flex sm:items-center sm:justify-between mb-6">
        <div class="sm:flex-auto">
            <h1 class="text-base font-semibold leading-6 text-slate-900 dark:text-white">Edit Klinik: {{ $clinic->name }}</h1>
            <p class="mt-2 text-sm text-slate-700 dark:text-slate-400">Perbarui data cabang.</p>
        </div>
    ...
    <div class="card p-6">
        <form action="{{ route('master-data.clinics.update', $clinic) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    ...
                    <div class="mt-2">
                        <input type="text" name="name" id="name" required value="{{ old('name', $clinic->name) }}" class="input-field">
                    </div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input type="text" name="phone" id="phone" value="{{ old('phone', $clinic->phone) }}" class="input-field">
                    </div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input type="email" name="email" id="email" value="{{ old('email', $clinic->email) }}" class="input-field">
                    </div>
                ...
                <div class="sm:col-span-2">
                    ...
                    <div class="mt-2">
                        <textarea name="address" id="address" rows="3" class="input-field">{{ old('address', $clinic->address) }}</textarea>
                    </div>
                ...
                <div class="sm:col-span-2">
                    <div class="relative flex items-start">
                        <div class="flex h-6 items-center">
                            <input id="is_active" name="is_active" type="checkbox" value="1" {{ old('is_active', $clinic->is_active ? '1' : '0') == '1' ? 'checked' : '' }} class="h-4 w-4 rounded border-gray-300 text-primary-600 focus:ring-primary-600">
                        </div>
