...
<div class="max-w-3xl mx-auto">
    <div class="sm:flex sm:items-center sm:justify-between mb-6">
        <div class="sm:flex-auto">
            <h1 class="text-base font-semibold leading-6 text-slate-900 dark:text-white">Tambah Dokter</h1>
            <p class="mt-2 text-sm text-slate-700 dark:text-slate-400">Masukkan data dokter baru ke dalam sistem.</p>
        </div>
    ...
    <div class="card p-6">
        <form action="{{ route('master-data.doctors.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input type="text" name="specialization" id="specialization" value="{{ old('specialization') }}" class="input-field" placeholder="Misal: Spesialis Mata">
                    </div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input type="text" name="sip_number" id="sip_number" value="{{ old('sip_number') }}" class="input-field" placeholder="Surat Izin Praktik">
                    </div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input type="email" name="email" id="email" value="{{ old('email') }}" class="input-field" placeholder="Email dokter">
                    </div>
